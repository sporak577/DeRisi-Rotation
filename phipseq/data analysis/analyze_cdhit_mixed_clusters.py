...
Input: 
- load FASTA file of peptide tiles used as input to CD-HIT 0.94
- A .clstr file procuded by CD-HIT 0.96 
...
with open(clstr_file) as f:
    ...
    if current_cluster: #final cluster is added only once, after all lines have been processed
        clusters.append(current_cluster)
...
with open(output_file, "w", newline="") as f:
    fieldnames = ["cluster_id", "num_tiles", "cluster_type", "strains", "accessions", "protein_names", "hosts", "countries"]
